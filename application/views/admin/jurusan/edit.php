                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="id-messages"></div>
                            <?php echo form_open('admin/jurusan/update', 'class="form-horizontal" method="post" id="form-tambah"'); ?>
 ...
 $(function() {
    $('#id').val('<?php echo $jurusan->id_jurusan;?>');
    $('#nama').val('<?php echo $jurusan->nama;?>');
});
