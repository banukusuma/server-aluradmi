                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="id-messages"></div>
                            <?php echo form_open('admin/jurusan/ajax_tambah', 'class="form-horizontal" method="post" id="form-tambah"'); ?>
                                  <div class="form-group">
                                      <label class="col-sm-2 control-label">Nama Jurusan 1</label>
                                      <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                      <div class="col-sm-offset-2 col-sm-9">
                                        ...
                                        <a class="btn btn-danger" href="<?php echo site_url('admin/jurusan');?>">Cancel</a>
                                        </div>
                                      </div>
                            <?php echo form_close();?>
                  </div>
...
$(function()
{
    $(document).on('click', '.btn-add', function(e)
    {
        ...
        var isi = '<div class="form-group">'+
                       '<label class="col-sm-2 control-label">Nama Jurusan '+next+'</label>'+
                        '<div class="col-sm-9">'+
