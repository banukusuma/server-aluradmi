  <div class="page-title">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="x_panel">
            <div class="x_title">
              <h2>Form Edit Gedung</h2>
              <div class="clearfix"></div>
            </div>
            <div class="x_content">
               <div id="id-messages"></div>
               <br>
              <?php echo form_open('admin/gedung/update', 'class="form-horizontal" 
...
<script type="text/javascript">    
   $(function() {
      $('#id').val('<?php echo $gedung->id_gedung; ?>');
      $('#nama').val('<?php echo $gedung->nama; ?>');
      $('#lat').val('<?php echo $gedung->latitude; ?>');
      $('#lng').val('<?php echo $gedung->longitude; ?>');
      $('#jumlah').val('<?php echo $lantai; ?>');
     });
  $('#form-tambah').submit(function(e){
      ...
      function initMap() {
        ...
        var myLatLng = {lat: <?php echo $gedung->latitude; ?>, lng: <?php echo $gedung->longitude; ?>};
        ...
        var map = new google.maps.Map(document.getElementById('map-canvas'), {
         ...
         var content_current = "Posisi " + '<?php echo $gedung->nama; ?>';
         infowindow2.setContent(content_current);
