              ...
              <div class="col-md-12">
                <div class="x_panel">
                  ...
                  <div id="id-messages"></div>
                            <?php echo form_open('admin/keterangan/update', 'class="form-horizontal" method="post" id="form-tambah"'); ?>
                            ...
                            <div class="form-group">
                               ...
                               <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <textarea id="keterangan" name="keterangan" type="text" class="form-control"><?php echo $keterangan->keterangan;?></textarea>     
                                      </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      <div class="col-sm-offset-2 col-sm-8">
                                        ...
                                        <a class="btn btn-danger cancel" href="<?php echo site_url('admin/keterangan'); ?>">Cancel</a>
                                        </div>
                                      </div>
    ...
    var lantai = $('#lantai');
    var ruang = $('#ruang');
    function isi_alur(id, id1,  id2 = null){
      return $.ajax({
      type: 'post',
      dataType: 'json',
      data: {kategori: id, jurusan: id1 },
      url: "<?php echo site_url('admin/keterangan/ajax_alur');?>",
      success: function(data){ 
            ket.append('<option value="">-- Pilih Alur --</option>');
    ...
    function isi_ruang(id, id2 = null){
      ...
      $.ajax({
          ...
          dataType: 'json',
          data: {lantai: id },
          url: "<?php echo site_url('admin/keterangan/ajax_ruang');?>",
          success: function(data){
    ...
    $(function(){
      isi_alur(<?php echo $keterangan->id_kategori;?>,<?php echo $keterangan->id_jurusan;?>,'<?php echo $keterangan->id_alur;?>');
      ...
      $('#nama').val('<?php echo $keterangan->nama;?>');
      $('#id').val('<?php echo $keterangan->id_keterangan;?>');
      $('#gedung').val('<?php echo $lokasi->id_gedung;?>');
      $('#kategori').val('<?php echo $keterangan->id_kategori;?>');
      $('#jurusan').val('<?php echo $keterangan->id_jurusan;?>');
