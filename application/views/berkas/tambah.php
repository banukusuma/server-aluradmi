                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div id="id-messages"></div>
                            <?php echo form_open('berkas/ajax_tambah', 'class="form-horizontal" method="post" id="form-tambah"'); ?>
                            ...
                            <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="hidden" name="jurusan" id="jurusan" value="<?php echo $this->session->userdata('id_jurusan');?>">
