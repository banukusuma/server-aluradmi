...
* 
*/
class Alur extends Super_Controller
{
	...
	function __construct()
	{
		...
		foreach ($list as $alur) {
			$row = array($alur->id_alur,$alur->nama_jurusan,$alur->nama_kategori, $alur->nama,   $alur->urut,
	...
	function index(){
		...
		$this->data['jurusan'] = $this->alur_m->pilih('jurusan', ' where id_jurusan != 0');
		$this->data['subview'] = 'admin/alur/index';
	...
	function edit($id){
		...
		$this->data['subview'] = 'admin/alur/edit';
		$this->load->view('_layout_main', $this->data);
	}
	function update(){
		...
		public function delete($id)
    	{
			...
			$max_urut = $no[0]['urut'];
	        if (count($this->alur_m->delete($id))) {
    	...
    	function tambah(){
    		...
    		$this->data['kategori'] = $this->alur_m->pilih('kategori');
			$this->data['jurusan'] = $this->alur_m->pilih('jurusan', ' where id_jurusan != 0');
			$this->data['subview'] = 'admin/alur/tambah';
			$this->load->view('_layout_main', $this->data);
    	}
    	...
    	function ajax_tambah(){
    		...
    		$this->data['kategori'] = $this->alur_m->pilih('kategori');
    		$this->data['jurusan'] = $this->alur_m->pilih('jurusan' ,'where id_jurusan != 0');
    		$this->data['subview'] = 'admin/alur/urut';
			$this->load->view('_layout_main', $this->data);
    	}
